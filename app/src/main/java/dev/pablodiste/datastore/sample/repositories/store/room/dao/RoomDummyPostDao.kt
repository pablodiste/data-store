...
@Dao
abstract class DummyPostsSourceOfTruth: RoomListSourceOfTruth<NoKey, DummyPost>("dummy_posts", RoomDatabase.roomDb) {
    override fun query(key: NoKey): String = ""
}

@Dao
abstract class DummyPostSourceOfTruth: RoomSourceOfTruth<DummyPostId, DummyPost>("dummy_posts", RoomDatabase.roomDb) {

...
```kotlin
implementation("dev.pablodiste.datastore:datastore:0.1.5")
```
...
implementation("dev.pablodiste.datastore:datastore-retrofit:0.1.5")
implementation("dev.pablodiste.datastore:datastore-ktor:0.1.5")
```
